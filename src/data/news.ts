...
Let’s step through those imposing wooden library doors, and learn a little more about CSP.</p>
      <br>
      <h2>Commitment to Long-Form Research</h2><br>
            <p>‘Cambridge Scholars Publishing are committed to supporting long-form research dissemination in all our fields of academic and scholarly publishing, through the publication of monographs and edited collections. This is, and will remain, our core focus.‘
...
So CSP’s business model is to run a lean, flat structure, which means administration and overhead costs are minimized. Their attention is focused on inclusion – inviting people to publish and getting books out into the market, and not on lengthy assessment on exclusion. Peer review is focused on proposals. An ‘author’s own voice’ is encouraged. Desk editors are instructed to help and improve, not to homogenize. CSP is a long way from a radical alternative publisher, but their business approach means they espouse some philosophies, particularly around inclusivity, marginalized voices and decolonization, that would not look out of place in some basement collective.</p>
<br>
      <h2>Think Global, Act Local</h2><br><br>
      <p>A quote attributed to economist Dr. Hazel Henderson, ‘Think Global, Act Local’ has been a mantra in business school teaching and corporate sloganizing since the 1980s. But the CSP story makes one think of it again.
...
Yet it’s a business which very much ‘thinks global’. In 2019, CSP opened a representative office at the prestigious Zhejiang University in Hangzhou, China, and has satellite offices in Berlin and Barcelona. It’s a business that negotiated a direct supply line to Ebsco’s GOBI Library Services for hard copy titles, as well as maintaining a flourishing and growing no-shelf-required ebook presence. It’s a publisher where a random trawl of one day’s submitted book proposals takes in the UK and USA, but also Turkey, Germany, India, China, Romania and Sweden, and one which reckons to have authors, and customers, from 120 countries worldwide.</p>
<br>
      <h2>Author-Centricity</h2><br>
      <p>‘We put our authors at the heart of everything we do.’
...
This author-centricity has created a highly effective commissioning referral and network effect structure. The academic community, though huge, is highly networked, and a fast, sympathetic, no-fuss publisher’s reputation ripples and grows. This network effect led to requests from outside CSP’s original Humanities and Social Sciences heartland to publish titles in some of the natural sciences and STEM subjects; to the point where, in 2018, Physical Sciences, Life Sciences and Health Sciences were formally added to CSP’s publishing portfolio.</p>
<br>
      <h2>Simple Things</h2><br><br>
      <p>We sometimes hear people describe academic book publishing as ‘traveling up a down escalator.’ You have to run, just to stand still. You have to run to move forwards. Slip, or stop for a moment, and you are back where you started. Even the best and brightest, armed with one of the world’s strongest scholarly brand names at Stanford, find themselves pulled downwards.
...
Every publishing company has a story, of course, but it is always refreshing to find one in an unexpected place, with a clear and optimistic narrative, a few surprises, and some good management practices.</p>
<br>
------------------------------------<br>
      <p>THE STORY of the majestic library building in Newcastle upon Tyne is a poignant one, published below and extracted, with permission, from CSP’s newsletter:</p>
<br>
      <h2>William Stephenson and Eliza Bond</h2><br>
      <p>William Haswell Stephenson was born near Newcastle in 1836, into a family of wealthy industrialists, with interests in coal and manufacture. He and Eliza married near her family home in Lincolnshire in 1862. A prominent and well-known figure in the city, William was Mayor of Newcastle on four occasions, before and after the turn of the century, and was knighted by Queen Victoria for his services to the community in 1900.
...
William Stephenson also outlived his daughter Charlotte, and died at the age of 82, in 1918.</p>
    `,
