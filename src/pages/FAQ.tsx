            ...
            {loading ? (
              ...
              <Accordion type="single" collapsible className="w-full space-y-3">
                {faqs.map((faq) => (
                  ...
                  >
                    <AccordionTrigger
                      className="text-left font-semibold py-3 px-[30px] text-[17px] leading-[1.6] [&>svg]:hidden hover:no-underline bg-[#F8F8F8] text-[#333333] data-[state=open]:bg-[#E4573D] data-[state=open]:text-white transition-colors"
                      style={{ fontFamily: '"Nunito Sans", sans-serif' }}
                    >
                      {faq.question}
                    </AccordionTrigger>
                    <AccordionContent className="text-[#696969] leading-[2] pt-5 pb-5 px-5 text-[16px] whitespace-pre-wrap bg-transparent" style={{ fontFamily: '"Nunito Sans", sans-serif' }}>
                      {faq.answer}
                    </AccordionContent>
                  </AccordionItem>
                ))}
