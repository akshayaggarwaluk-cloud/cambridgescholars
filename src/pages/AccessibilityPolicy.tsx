      ...
      <main className="flex-1 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-primary mb-4">Our Legal Commitment</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          {/* What We Offer */}
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-primary mb-4">What We Offer</h2>
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-primary mb-4">Accessibility Features</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              We have designed our website and digital content to be:
            </p>
            <ul className="space-y-3 text-muted-foreground">
              <li>
                <strong className="text-foreground">Perceivable:</strong> Text alternatives are provided for images and multimedia, captions are included for videos and content is clear and readable.
              </li>
              <li>
                <strong className="text-foreground">Operable:</strong> The website can be fully navigated using a keyboard and the interface is user friendly.
              </li>
              <li>
                <strong className="text-foreground">Understandable:</strong> Content is written in clear language and follows a consistent layout.
              </li>
              <li>
                <strong className="text-foreground">Robust:</strong> Our content is compatible with screen readers and other assistive technologies.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-primary mb-4">Ongoing Improvements and Testing</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-primary mb-4">Feedback and Assistance</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
