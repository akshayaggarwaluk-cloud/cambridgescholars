       ...
       <main className="pb-16 bg-white">
        <div className="container-wide py-12 bg-white">
          ...
          <div className="grid grid-cols-[1fr_120px_180px_140px_60px] gap-6 pb-5 border-b border-border items-center">
            ...
            <div className="uppercase text-[#333333] font-baskerville tracking-wider text-sm font-semibold text-center relative -left-3">Price</div>
            <div className="uppercase text-[#333333] font-baskerville tracking-wider text-sm font-semibold text-center relative -left-3">Quantity</div>
            <div className="uppercase text-[#333333] font-baskerville tracking-wider text-sm font-semibold text-center relative -left-3">Total</div>
            <div></div>
          </div>
