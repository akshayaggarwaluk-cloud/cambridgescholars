      ...
      <section className="container-wide py-16">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <p className="text-lg text-muted-foreground leading-relaxed mb-6">
            ...
            <span className="text-accent">This section</span> provides a comprehensive guide to the next steps in the publishing process. Here, you will find everything you need to begin, including an overview of the{" "}
            <span className="text-accent">publication workflow</span>, the{" "}
