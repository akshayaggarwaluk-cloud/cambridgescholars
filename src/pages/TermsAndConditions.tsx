      ...
      <main className="flex-1 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-black text-2xl font-semibold text-primary mb-4 text-[26px]">
              1. Definitions
            </h2>
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-primary mb-4 text-black text-[26px]">
              2. Description of Items
            </h2>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 ttext-black text-[15px]">
              <li>
           ...
           */}
          <section className="mb-8">
            <h2 className="text-black font-playfair text-2xl font-semibold text-primary mb-4 text-[26px]">
              7. Complaints
            </h2>
            <p className="text-black leading-relaxed text-[15px]">
