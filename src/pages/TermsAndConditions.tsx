      ...
      <main className="flex-1 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">1. Definitions</h2>
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">2. Description of Items</h2>
            <p className="leading-relaxed text-black">
          ...
          {/* 3. Pricing and Taxes */}
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">3. Pricing and Taxes</h2>
          ...
          {/* 4. Delivery */}
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">4. Delivery</h2>
            <p className="leading-relaxed text-black">
          ...
          {/* 5. Payment */}
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">5. Payment</h2>
            <p className="leading-relaxed text-black">
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">6. Intellectual Property</h2>
            <p className="leading-relaxed text-black">
          ...
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">7. Limitation of Liability</h2>
            <p className="leading-relaxed text-black">
          ...
          {/* 8. Changes to Terms */}
          <section className="mb-8">
            <h2 className="font-playfair text-2xl font-semibold text-black mb-4">8. Changes to Terms</h2>
            <p className="leading-relaxed text-black">
          ...
          <section className="mb-8">
            ...
            <p className="leading-relaxed text-black">
              ...
              <a href="mailto:admin@cambridgescholars.com" className="text-black underline">
