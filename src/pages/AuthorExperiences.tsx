              ...
              {reviews.map((review, index) => {
                ...
                return (
                  <div key={index}>
                    ...
                    <div className="flex flex-col items-center md:flex-row md:items-start gap-6 md:gap-8 py-10 px-4 md:px-6">
                      {/* Book cover */}
                      <div className="flex-shrink-0 w-32 sm:w-40 md:w-36 lg:w-40">
                        {review.coverImage ? (
                          <img
