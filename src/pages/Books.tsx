                      ...
                      <div className="flex flex-col md:flex-row gap-10">
                        ...
                        <div className="flex-1 flex flex-col">
                          ...
                          <div className="flex items-center gap-3 mt-auto pt-6">
                            <Button
                              asChild
                              className="bg-[#e4573d] hover:bg-[#e4573d]/80 text-white px-7 h-11 text-xs font-bold tracking-[0.18em] uppercase rounded-none transition-colors font-['Nunito_Sans']"
                            >
