              ...
              {loginError && (
                <div className="mb-6 bg-red-50 border-l-4 border-red-500 p-4 flex items-start gap-3">
                  <AlertTriangle className="h-5 w-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <p className="text-lg font-sans font-normal text-foreground/80 tracking-wide">
              ...
              {registerStep === "details" ? (
                <form onSubmit={handleSendOtp} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-lg font-sans font-normal text-foreground/80 leading-relaxed tracking-wide">
