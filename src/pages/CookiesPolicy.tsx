...
"
      ...
      <main className="flex-1 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Introduction */}
          <div className="mb-8">
            <p className="text-muted-foreground leading-relaxed text-black">
              Cambridge Scholars Publishing uses cookies to improve your browsing experience and to understand how our
              website is used.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4 text-black">
          ...
          <section className="mb-8">
            <h2 className=" text-black font-playfair text-2xl font-semibold text-primary mb-4">We use cookies to:</h2>
            ...
            <p className="text-black text-muted-foreground leading-relaxed mt-4">
          ...
          <section className="mb-8">
            <h2 className="text-black font-playfair text-2xl font-semibold text-primary mb-4">
              Types of Cookies We Use
            </h2>
            <ul className="space-y-3 text-muted-foreground">
              <li>
                <strong className="text-black text-foreground">Essential cookies</strong> – required for the website to
                function properly
              </li>
              <li>
                <strong className="text-black text-foreground">Analytics cookies</strong> – help us understand how
                visitors use our site so we can improve it
              </li>
              <li>
                <strong className="text-black text-foreground">Preference cookies</strong> – remember choices you make
          ...
          {/* Your Choices */}
          <section className="mb-8">
            <h2 className="text-black font-playfair text-2xl font-semibold text-primary mb-4">Your Choices</h2>
            <p className="text-black text-muted-foreground leading-relaxed">
