    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 py-12 md:py-16 bg-white">
        <div className="max-w-xl mx-auto px-4">
           <p className="text-base font-sans font-normal text-base text-foreground leading-relaxed mb-8">
          ...
          {error && (
            <div className="mb-6 bg-red-50 border-l-4 border-red-500 p-4 flex items-start gap-3">
              <AlertTriangle className="h-5 w-5 text-red-500 flex-shrink-0 mt-0.5" />
               <p className="text-base font-sans font-normal text-foreground text-base">
