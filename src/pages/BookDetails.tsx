              ...
              <div className="flex flex-col gap-6 lg:pt-2">
                ...
                <div className="flex items-center gap-3 sm:gap-4 lg:gap-3 flex-wrap lg:flex-nowrap">
                 <div className="text-[#c4a273] text-lg font-semibold" style={{ fontFamily: '"Nunito Sans", sans-serif' }}>
                  ...
                  <Button
                    size="default"
                      className="px-[30px] py-[14px] h-auto font-serif uppercase tracking-wider text-[20px] font-normal bg-[#e4573d] hover:bg-black text-white"
                    onClick={() => {
                      const formatIsbn =
                        selectedFormat === "ebook"
                  ...
                  {book.samplePdfUrl && (
                    <Button size="default" variant="outline" className="px-[30px] py-[14px] h-auto font-serif uppercase tracking-wider text-[20px] font-normal border border-black bg-white text-black hover:bg-[#e4573d] hover:text-white hover:border-[#e4573d]" onClick={() => window.open(book.samplePdfUrl, "_blank")}>
                      READ SAMPLE
                    </Button>
                  )}
                </div>
