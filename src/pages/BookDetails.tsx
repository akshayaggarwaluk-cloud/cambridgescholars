            ...
            <div className="flex flex-col justify-start md:max-h-[420px] lg:max-h-[480px] overflow-hidden">
              ...
              <div>
                ...
                <p className="hidden sm:block text-xs md:text-sm text-muted-foreground leading-relaxed mb-3 md:mb-4">
                  {book.blurb?.slice(0, 120)}
                  {book.blurb && book.blurb.length > 120 ? "..." : ""}
                </p>
                  ...
                  <div className="flex flex-wrap gap-1.5 md:gap-2">
                    ...
                    >
                      <Tablet
                        className={cn(
                          ...
                          selectedFormat === "ebook" ? "text-accent" : "text-muted-foreground",
                        )}
                      />
                      <div className="text-left">
                        <p
                          className={cn(
                            ...
                            selectedFormat === "ebook" ? "text-accent" : "text-foreground",
                          )}
                        >
                          eBook
                        </p>
                    ...
                    >
                      <BookOpen
                        className={cn(
                          "h-3 w-3 md:h-4 md:w-4",
                          selectedFormat === "paperback" ? "text-accent" : "text-muted-foreground",
                        )}
                      />
                      <div className="text-left">
                        <p
                          className={cn(
                            "text-xs md:text-sm font-medium",
                            selectedFormat === "paperback" ? "text-accent" : "text-foreground",
                          )}
                        >
                          Paperback
                        </p>
                ...
                <div className="flex items-center gap-4 md:gap-6 mb-1 md:mb-2">
                  ...
                  <div className="flex items-center border border-border">
                    ...
                    <span className="px-2 md:px-3 py-1 min-w-[32px] md:min-w-[40px] text-center text-xs md:text-sm font-medium">
                      {quantity}
                    </span>
                    <button
                ...
                <div className="flex items-center gap-2 md:gap-3 flex-wrap">
                  ...
                  >
                    <Heart
                      className={cn("h-3 w-3 md:h-4 md:w-4", isInWishlist(book.id) && "fill-accent text-accent")}
                    />
                  </Button>
