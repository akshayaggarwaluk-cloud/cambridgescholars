            ...
            >
              <div>
                ...
                {book.shortDescription && (
                  <p
                    className="hidden sm:block leading-7 lg:leading-7 max-w-3xl mb-6 lg:mb-0 text-base font-medium text-[#696969]"
              ...
              <div className="flex flex-col gap-6 lg:pt-2">
                  ...
                  <div className="flex gap-3 lg:gap-2.5">
                    {hasHardback && (
                      ...
                      >
                        ...
                        <span style={{ fontFamily: '"Nunito Sans", system-ui, sans-serif' }} className={cn("tracking-wider normal-case text-sm font-normal", selectedFormat === "hardbook" ? "text-accent" : "text-foreground")}>HARDBACK</span>
                    ...
                    {hasPaperback && (
                      ...
                      >
                        ...
                        <span style={{ fontFamily: '"Nunito Sans", system-ui, sans-serif' }} className={cn("tracking-wider normal-case text-sm font-normal", selectedFormat === "paperback" ? "text-accent" : "text-foreground")}>PAPERBACK</span>
                    ...
                    {hasEbook && (
                      ...
                      >
                        ...
                        <span style={{ fontFamily: '"Nunito Sans", system-ui, sans-serif' }} className={cn("tracking-wider normal-case text-sm font-normal", selectedFormat === "ebook" ? "text-accent" : "text-foreground")}>EBOOK</span>
                ...
                <div className="flex items-center gap-4 sm:gap-6">
                  <span style={{ fontFamily: '"Nunito Sans", system-ui, sans-serif' }} className="tracking-wider normal-case text-sm uppercase font-semibold">QUANTITY</span>
                  <div className="flex items-center border">
                    ...
                    <span style={{ fontFamily: '"Nunito Sans", system-ui, sans-serif' }} className="px-3 sm:px-4 py-1.5 sm:py-2 lg:px-3 lg:py-1.5 min-w-[40px] sm:min-w-[50px] text-center tracking-wider text-sm font-normal">{quantity}</span>
                ...
                <div className="flex items-center gap-3 sm:gap-4 lg:gap-3 flex-wrap lg:flex-nowrap">
                  <div className="text-[#c4a273] text-lg font-semibold" style={{ fontFamily: '"Libre Baskerville", Georgia, serif' }}>
                   <span className="font-semibold text-[#c4a273] text-lg">£{getPrice(selectedFormat).toFixed(2)}</span>
                  </div>
                  <Button
                    size="default"
