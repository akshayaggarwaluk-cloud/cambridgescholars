            ...
            <div className="flex flex-col justify-between" style={imageHeight && window.innerWidth >= 1024 ? { height: imageHeight } : undefined}>
              <div>
                ...
                <div className="flex items-center gap-4 sm:gap-6 mb-[15px] sm:mb-0 mt-[10px]">
                  <span className="text-xs sm:text-sm font-semibold uppercase tracking-wide" style={{ fontFamily: '"Nunito Sans", sans-serif' }}>Quantity</span>
              ...
              <div className="flex items-center gap-3 sm:gap-4 flex-wrap my-[20px] sm:my-[30px] mb-0 mt-0">
                ...
                <Button
                  size="lg"
                   className="px-8 font-serif tracking-wider normal-case text-sm font-light hover:bg-foreground hover:text-background"
                  onClick={() => {
