  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/post-publication" element={<PageTransition><EndorsementSubmission /></PageTransition>} />
        <Route path="/endorsement-submission" element={<Navigate to="/post-publication" replace />} />
        <Route path="/reviewer-form" element={<Navigate to="/post-publication" replace />} />
