      ...
      <div className="container-wide relative z-10">
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <ScrollAnimation type="slideLeft" className="lg:col-span-2 flex justify-center lg:justify-start">
            <motion.div 
              className="relative w-64 md:w-72 lg:w-full max-w-xs perspective-1000"
            ...
            >
              ...
              {/* Floating glow */}
              <motion.div 
                className="absolute -inset-8 bg-accent/10 rounded-full blur-3xl -z-20"
                animate={{
                  scale: [1, 1.1, 1],
                  opacity: [0.3, 0.5, 0.3],
                }}
              ...
              <motion.img
                ...
                className="w-full h-auto shadow-xl rounded-sm relative z-10"
                whileHover={{ 
                  rotateY: 5,
                  rotateX: -2,
                }}
          ...
          <ScrollAnimation type="fadeUp" delay={0.2} className="lg:col-span-3 space-y-5">
            <motion.span 
              className="inline-flex items-center gap-2 text-accent text-xs font-semibold uppercase tracking-[0.15em] bg-accent/10 px-4 py-2 rounded-full"
            ...
            <div className="flex flex-wrap gap-2 text-xs text-muted-foreground">
              <Link 
                ...
                className="inline-flex items-center gap-1 px-3 py-1 bg-secondary rounded-full hover:bg-accent hover:text-accent-foreground transition-all duration-300"
              >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Button 
                asChild
                size="lg"
                className="bg-accent hover:bg-accent/90 text-accent-foreground rounded-full shadow-accent hover:shadow-lg transition-all duration-300 hover:scale-105 group"
              >
              ...
              <Button 
                ...
                size="lg"
                variant="outline"
                className="rounded-full border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground transition-all duration-300"
              >
