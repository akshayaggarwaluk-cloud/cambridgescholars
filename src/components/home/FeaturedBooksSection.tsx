        ...
        <div className="relative grid md:grid-cols-[1.4fr_0.6fr] gap-8 items-center min-h-[500px]">
          <div className="order-2 md:order-1">
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-[#e4573d] uppercase tracking-[0.3em] text-lg font-medium">Featured Book</p>
                ...
                <Button asChild className="bg-[#e4573d] hover:bg-[#e4573d]/90 text-accent-foreground px-16 py-3.5 text-sm tracking-[0.2em] rounded-none uppercase">
