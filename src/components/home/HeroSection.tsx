            ...
            <AnimatePresence mode="wait">
              ...
              >
                <img
                  ...
                  className="max-h-full max-w-full w-auto h-full object-contain object-center lg:object-right mx-auto lg:mx-0 scale-110 lg:scale-125 origin-center lg:origin-right"
                />
              </motion.div>
            </AnimatePresence>
          </div>
