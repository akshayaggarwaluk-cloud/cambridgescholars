    ...
    >
      <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.h1 variants={textVariants} transition={{ duration: 0.4, delay: 0.05 }} className="font-baskerville text-3xl md:text-4xl font-normal leading-[1.65] text-foreground lg:text-4xl">{activeReview.bookTitle}</motion.h1>
                 {activeReview.author && (
                   <motion.p variants={textVariants} transition={{ duration: 0.4, delay: 0.1 }} className="text-foreground text-sm font-medium font-nav md:text-lg">By {activeReview.author}</motion.p>
                 )}
                ...
                <motion.div variants={textVariants} transition={{ duration: 0.4, delay: 0.25 }} className="pt-2">
                  <Button asChild className="bg-accent hover:bg-accent/90 text-accent-foreground px-10 py-3 text-sm tracking-wider font-nav">
          ...
          <div className="relative order-1 lg:order-2 h-[350px] md:h-[440px] lg:h-[540px] flex items-center justify-center lg:justify-end">
            <AnimatePresence mode="wait">
              <motion.div
                key={activeIndex}
