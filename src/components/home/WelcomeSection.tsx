        ...
        <StaggerContainer staggerDelay={0.15} className="grid md:grid-cols-3 gap-6 md:gap-8">
          {services.map((service) => (
            <StaggerItem key={service.title}>
              <motion.div
                className={`group relative bg-card border border-border rounded-2xl p-6 md:p-8 text-center transition-all duration-500 hover:border-accent/40 overflow-hidden`}
                whileHover={{ 
                  y: -8, 
              ...
              >
                ...
                <div className="relative z-10">
                  <motion.div 
                    className="flex items-center justify-center h-20 mb-6"
                  ...
                  <h3 className="font-serif text-xl font-semibold text-foreground mb-4 group-hover:text-accent transition-colors duration-300">
                    {service.title}
                  </h3>
                  ...
                  <Link
                    to={service.link}
                    className="inline-flex items-center gap-2 text-accent font-medium text-sm uppercase tracking-wider group/link"
                  >
