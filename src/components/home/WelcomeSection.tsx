  ...
  return <section className="py-16 md:py-24 bg-background">
      <div className="container-wide">
        ...
        <div className="flex justify-center mb-8">
          <img alt="Cambridge Scholars Publishing" src="/lovable-uploads/6a63ba27-44ab-44bd-a4af-b922c30c49cd.png" className="h-32 md:h-72 w-auto object-contain" />
        </div>

        {/* Welcome Message */}
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16">
          <h6 className="text-xs font-semibold uppercase tracking-[0.15em] text-accent mb-4">
