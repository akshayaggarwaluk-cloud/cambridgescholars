    ...
    <section className="py-8 md:py-12">
      <div className="mx-4 sm:mx-6 lg:mx-8 bg-white rounded-sm py-10 md:py-14 px-6 sm:px-10 lg:px-16">
        ...
        <ScrollAnimation type="fadeUp" delay={0.1} className="max-w-5xl mx-auto text-center mb-14">
          ...
          <p className="font-nav text-[15px] leading-loose max-w-[680px] mx-auto text-center text-[#333333]">
            ...
            <StaggerItem key={service.title}>
              <div className="group text-left p-6 md:p-8 flex flex-col h-full">
                ...
                <Link
                  to={service.link}
                  style={{ color: "#E4573D" }}
                  className="font-nav inline-flex items-center gap-2 uppercase tracking-normal group/link hover:gap-3 transition-all duration-300 font-semibold text-sm"
                >
                  READ MORE
